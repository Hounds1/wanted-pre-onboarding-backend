...
6. 게시글 좋아요 기능
7. 좋아요(추천) 수 상위 10개(임시) 캐싱 기능 (Redis) 문서는 [여기](https://github.com/Hounds1/wanted-pre-onboarding-backend/blob/dev/src/main/java/me/hounds/wanted/onboarding/global/redis/markdown/RedisPolish.md)를 눌러주세요.
